            ...
            <form id="quickOrderFrom" class="repeater" method="post">
                ...
                <div class="repeaterItem">
                    <div class="input-group">
                        <input type="text" class="form-control" name="item" placeholder="Item #" aria-label="Item #" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" />
